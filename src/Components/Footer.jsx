          ...
          <div className="col-lg-3 col-md-6">
            <div className="footer-info">
              ...
              <div className="social-links mt-3">
                <a href="https://twitter.com/VITAIIoT"><span className="social"><i className="bi bi-twitter"></i></span></a>
                <a href="https://www.facebook.com/profile.php?id=61552160249000" ><span className="social"><i className="bi bi-facebook"></i></span></a>
                <a href="https://www.instagram.com/vitaiiot/"><span className="social"><i className="bi bi-instagram"></i></span></a>
                <a href="https://www.linkedin.com/in/vitaiiot-india-985352295/"><span className="social"><i className="bi bi-linkedin"></i></span></a>
              </div>
            </div>
          </div>
        </div>
